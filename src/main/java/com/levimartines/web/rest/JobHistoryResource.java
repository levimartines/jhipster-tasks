package com.levimartines.web.rest;

import com.levimartines.domain.JobHistory;
import com.levimartines.service.JobHistoryService;
import com.levimartines.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.levimartines.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
     ...
     * jobHistory, or with status {@code 400 (Bad Request)} if the jobHistory has already an ID.
    ...
    public ResponseEntity<JobHistory> createJobHistory(@RequestBody JobHistory jobHistory)
        ...
        if (jobHistory.getId() != null) {
            throw new BadRequestAlertException("A new jobHistory cannot already have an ID",
     ...
     * jobHistory, or with status {@code 400 (Bad Request)} if the jobHistory is not valid, or with
     * status {@code 500 (Internal Server Error)} if the jobHistory couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/job-histories")
    public ResponseEntity<JobHistory> updateJobHistory(@RequestBody JobHistory jobHistory)
        throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of jobHistories
     * in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the jobHistory,
