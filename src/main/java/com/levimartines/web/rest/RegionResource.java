...
import com.levimartines.service.RegionService;
...
/**
 * REST controller for managing {@link com.levimartines.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     * region, or with status {@code 400 (Bad Request)} if the region has already an ID.
    ...
    public ResponseEntity<Region> createRegion(@RequestBody Region region)
        ...
        if (region.getId() != null) {
            throw new BadRequestAlertException("A new region cannot already have an ID",
     ...
     * region, or with status {@code 400 (Bad Request)} if the region is not valid, or with status
     * {@code 500 (Internal Server Error)} if the region couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/regions")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the region, or
