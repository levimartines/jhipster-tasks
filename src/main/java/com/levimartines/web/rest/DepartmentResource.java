...
import com.levimartines.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.levimartines.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
     ...
     * department, or with status {@code 400 (Bad Request)} if the department has already an ID.
     ...
     * department, or with status {@code 400 (Bad Request)} if the department is not valid, or with
     * status {@code 500 (Internal Server Error)} if the department couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of departments
     * in body.
     */
