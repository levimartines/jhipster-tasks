...
import com.levimartines.service.LocationService;
...
/**
 * REST controller for managing {@link com.levimartines.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public ResponseEntity<Location> createLocation(@RequestBody Location location)
        ...
        if (location.getId() != null) {
            throw new BadRequestAlertException("A new location cannot already have an ID",
